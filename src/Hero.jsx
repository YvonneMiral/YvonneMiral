...
//   return (
//     <>
//       <section id="home" className="hero-split" style={{ backgroundImage: `url(${bg2})` }}>
//   <div className="hero-overlay"></div>

//   <div className="hero-container">
//     {/* LEFT: Text Content */}
//     <div className="hero-text">
//       <p className="hero-eyebrow">WEBSITE • UI/UX • MULTIMEDIA</p>
//       <h1 className="hero-title">
//         Hi, I'm <span className="gradient-text"><TypingText text="Yvonne Miral" speed={80} cursor="|" /></span>
//       </h1>
//       <p className="hero-subtitle">
//         A passionate Website & UI/UX Developer and Video Editor who transforms ideas into
//         interactive digital experiences. Based in Iligan City, Philippines.
//       </p>

//       <div className="hero-buttons">
//         <ScrollLink className="btn-modern primary" to="projects" smooth duration={500} offset={-50}>
//           <i className="fa-solid fa-rocket"></i> See Projects
//         </ScrollLink>
//         <a className="btn-modern outline" href={resumePDF} target="_blank" rel="noopener noreferrer">
...
//         <i className="fab fa-react icon react"></i>
//         <i className="fab fa-python icon python"></i>
//         <i className="fab fa-js-square icon js"></i>
//         <i className="fa-solid fa-database icon db"></i>
//         <i className="fa-solid fa-video icon video"></i>
//       </div>
//     </div>
//   </div>
// </section>
...
//                 <h2 className="gradient-title">My Journey in Tech</h2>
//                 <p>
...
//                 </p>
//                 <p>
//                   With expertise in <strong>UI/UX</strong>, <strong>databases</strong>, and
//                   <strong> full-stack systems</strong>, I bring creative problem-solving and modern tech
...
//             <h2 className="timeline-title">My Path So Far</h2>
...
//             <h2 className="timeline-title">Core Skills</h2>
